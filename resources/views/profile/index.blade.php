    ...
    <div class="w-full flex flex-col">
        <div class="mt-4 bg-white w-full h-max rounded-3xl shadow-md flex flex-col lg:items-center overflow-hidden lg:flex-row">
            ...
            <div class="w-full flex justify-center lg:w-1/4">
                <img src="{{ asset('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsPUEdlaqIwNG_xq3PtlWjuD_kxkV7ovsmcQ&usqp=CAU') }}" alt="" class="w-32 h-32 rounded-full">
            </div>
            <hr class="lg:hidden mt-6">
            <form action="" class="py-6 flex flex-col gap-3 w-full">
                <div class="flex flex-col px-6">
                    <label for="fullname" class="text-slate-500">Fullname</label>
                    <input type="text" id="fullname" placeholder="Fullname" class="w-full border px-3 py-2 rounded-lg">
                </div>
                <div class="flex flex-col px-6">
                    <label for="username" class="text-slate-500">Username</label>
                    <input type="text" id="username" placeholder="Username" class="w-full border px-3 py-2 rounded-lg">
                </div>
                <div class="flex flex-col px-6">
                    <label for="whatsapp" class="text-slate-500">WhatsApp</label>
                    <input type="number" id="whatsapp" placeholder="WhatsApp" class="w-full border px-3 py-2 rounded-lg">
                    <small>
                        you don't add whatsapp! 
                ...
                <div class="flex flex-col px-6">
                    ...
                    <input type="number" id="email" placeholder="Email" class="w-full border px-3 py-2 rounded-lg">
                    <small>
                        you don't add email! 
                ...
                <div class="flex flex-col px-6">
                    ...
                    <input type="file" id="image" class="w-full border px-3 py-2 rounded-lg">
                </div>
