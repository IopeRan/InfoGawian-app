    ...
    <div class="bg-white w-full h-max rounded-lg shadow-md overflow-hidden lg:w-1/4">
        ...
        <div class="p-3">
            ...
            <form action="" method="post" class="flex flex-col gap-3">
                @method('post')
                @csrf
                <input type="text" id="username" name="username" class="px-3 py-1 w-full border rounded-lg " placeholder="Username" >
                <input type="Password" id="password" name="password" class="px-3 py-1 w-full border rounded-lg " placeholder="Password" >
