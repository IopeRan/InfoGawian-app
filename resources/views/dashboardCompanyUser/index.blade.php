...
@section('container')
    ...
    <div class="bg-white w-full h-max rounded-3xl my-6 flex flex-col overflow-hidden">
        ...
        <div class="px-6 lg:flex lg:py-3 lg:items-center">
            <div>
            ...
            <div>
                ...
                <div class="flex justify-end">
                    <button type="button" onclick="editCompany()" class="px-3 py-2 bg-teal-500 rounded-lg text-white hover:bg-teal-400 hover:duration-150 mt-6 lg:px-6">Edit</button>
                </div>
            </div>
        </div>
