<div id="editPost" class="hidden justify-center items-center w-full fixed top-6">
    <div class="bg-white w-full lg:w-1/3 h-max rounded-3xl mx-6 flex flex-col overflow-hidden">
        ...
        <div class="px-6 pt-6">
            <div class="flex flex-col">
                <h5 class="text-slate-500 font-medium text-lg lg:text-xl">Edit Post</h5>
                <small class="text-slate-400 lg:text-md">17/08/2024</small>
            </div>
            <hr class="mt-3">
            <form action="" class="w-full flex flex-col gap-4 mt-4">
                <textarea class="border w-full rounded-xl outline-yellow-500 px-3 py-2 shadow-md" placeholder="Post"></textarea>
                <div class="flex justify-between">
                    ...
                    <button type="submit" class="px-6 py-2 text-white font-medium bg-yellow-500 rounded-xl hover:bg-yellow-400 hover:duration-150">Save Change</button>
                </div>
            </form>
        </div>
