<div id="editCompany" class="hidden justify-center items-center w-full fixed top-6">
    <div class="bg-white w-full lg:w-1/3 h-max rounded-3xl flex flex-col overflow-hidden mx-6">
        ...
        <div class="px-6 pt-6">
            <div class="flex flex-col">
                <h5 class="text-slate-500 font-medium text-lg lg:text-xl">Edit Company</h5>
            ...
            <form action="" class="w-full flex flex-col gap-4 mt-4">
                ...
                <div class="flex justify-between">
                    <button type="button" onclick="cancelEditCompany()" class="px-6 py-2 font-medium border-red-500 border text-red-500 rounded-xl hover:bg-red-500 hover:duration-150 hover:text-white">Cancel</button>
